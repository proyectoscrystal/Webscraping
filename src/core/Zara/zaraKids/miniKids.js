...
exports.miniKids = async () => {
    ...
    try {
        ...
        await page.goto("https://www.zara.com/co/es/ninos-recien-nacido-join-life-l494.html?v1=1889586");
        ...
        for (let enlace of enlaces) {
            ...
            prendasMiniKids.forEach((dato) => {dato.categoria = nombrecategoria});
