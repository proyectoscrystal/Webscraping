...
exports.averageDiscountWeekGeneral = (arr) => {
    ...
    //     if (fecha > new Date(currentYear,11,3,12).getTime()) {
    //         console.log("funciona");
    //     } else if(fecha < new Date(currentYear,11,3)){
    //         console.log("funciona y es mayor la fecha")
    //         console.log(new Date(currentYear,11,3).getTime());
    //     }
